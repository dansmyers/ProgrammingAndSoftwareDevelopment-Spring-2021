...
To access the text, create an account on the ZyBooks site, https://learn.zybooks.com. Enter the ZyBook code: ROLLINSCMS121MyersFall2020. The subscription is $88 and lasts until after the final exam.
...
4. **Reading comprehension questions** from the online ZyBook.
...
Each homework assignment and quiz will consist of a number of parts, with the typical assignment having about five parts and each quiz having four questions. Your final letter grade will be based on the total number of **points** that you receive credit for over the entire semester, inclusive of all of the homework assignments and quizzes.

For the programming homeworks, you will receive credit for each part of the assignment if your program is complete and meets the written specifications given in the assignment description. Some assignments will have multiple short questions; others will have one larger program with credit broken down into multiple parts.

For the quizzes, I will award you credit for each individual question based on the "substantially complete and correct" standard described above.
...
| Earning less than 85%, 80%, etc. of the total homework and quiz points | Fraction of a letter grade for each 5%       |                   
| Each incomplete ZyBook chapter | Fraction of a letter grade |
| Unsatisfactory final project               | A full letter grade (e.g. B to C) |

These penalties are cumulative. For example, if you failed to satisfactorily complete two ZyBook chapters, your base grade would be lowered by two fractions of a letter, from B to C+.
